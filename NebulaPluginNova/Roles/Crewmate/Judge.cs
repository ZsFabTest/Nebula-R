    ...
    static public void OnMeetingStart(int leftGuess, bool canJudgeNeutralRoles, bool canJudgeMadmate, bool canJudgeLovers)
    {
        ...
        NebulaAPI.CurrentGame?.GetModule<MeetingPlayerButtonManager>()?.RegisterMeetingAction(new(targetSprite,
            state => {
                ...
                if(p?.Role.Role.Category == RoleCategory.ImpostorRole)
...
{
    private Judge() : base("judge", new(219, 162, 25), RoleCategory.CrewmateRole, Crewmate.MyTeam, [NumOfGuessOption, CanJudgeNeutralRolesOption, CanJudgeMadmateOption, CanJudgeLoversOption, CanCallEmergencyMeetingOption]) 
    {
    ...
    public class Instance : RuntimeAssignableTemplate, RuntimeRole
    {
        ...
        [Local]
        void OnMeetingStart(MeetingStartEvent ev) => JudgeSystem.OnMeetingStart(leftGuess, CanJudgeNeutralRolesOption.GetValue(), CanJudgeMadmateOption.GetValue(), CanJudgeLoversOption.GetValue());
