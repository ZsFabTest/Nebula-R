...
public class Assassin : DefinedRoleTemplate, HasCitation, DefinedRole
{
    ...
    public class Leaves : NebulaSyncStandardObject
    {
        ...
        private static SpriteLoader sprite = SpriteLoader.FromResource("Nebula.Resources.Leaves.png", 175f);
    ...
    public class Instance : RuntimeAssignableTemplate, RuntimeRole
    {
        ...
        void RuntimeAssignable.OnActivated()
        {
            if (AmOwner)
            {
                ...
                var myTracker = Bind(ObjectTrackers.ForPlayer(null, MyPlayer, ObjectTrackers.ImpostorKillPredicate));
                ...
                {
                    if (Target != null) new StaticAchievementToken("assassin.common");
        ...
        int killNum = 0;
        [Local]
        void OnMurder(PlayerMurderedEvent ev)
        {
            if (ev.Player.AmOwner && ev.Dead.PlayerId != MyPlayer.PlayerId)
                if (++killNum >= 5)
